...
//   return (
//     <CardMe title="Latest Blog Posts">
//       <div className="space-y-6">
//         {items.map((blog) => (
//           <div key={blog.id} className="group border-b border-gray-700 pb-6 last:border-b-0 hover:bg-gray-800/30 -mx-4 px-4 py-2 rounded-lg transition-all duration-300">
//             <div className="flex items-start gap-3">
//               <div className="flex-1">
//                 <h4 className="font-semibold text-white group-hover:text-emerald-300 transition-colors duration-200">
//                   {blog.title}
//                 </h4>
...
//                   )}
//                   {blog.platform && (
//                     <span className="text-emerald-300">{blog.platform}</span>
//                   )}
//                 </div>
...
//                   {blog.tags?.map((tag) => (
//                     <Badge key={tag} variant="secondary" className="bg-gray-700 text-gray-300 text-xs hover:bg-emerald-700 transition-colors duration-200">
//                       {tag}
//                     </Badge>
//                   ))}
//                 </div>
...
//                     className="inline-flex items-center gap-1 text-sm text-emerald-300 hover:text-emerald-200 transition-colors duration-200"
//                   >
//                     Read Article
